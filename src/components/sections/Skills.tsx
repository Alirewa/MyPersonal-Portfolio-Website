    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mb-12">
          ...
          <div className="absolute right-0 top-0 bottom-4 w-14 pointer-events-none lg:hidden hidden dark:block rounded-r-2xl"
            style={{ background: 'linear-gradient(to left, #06060a 0%, transparent 100%)' }} />
          {/* Scroll-continue shadow — light */}
          <div className="absolute right-0 top-0 bottom-4 w-14 pointer-events-none lg:hidden dark:hidden rounded-r-2xl"
